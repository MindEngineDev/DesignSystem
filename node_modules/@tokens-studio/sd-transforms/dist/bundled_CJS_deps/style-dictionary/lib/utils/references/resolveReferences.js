 ...
 */
function resolveReferences(value, tokens, opts) {
    ...
    if (typeof ref !== 'undefined') {
      if (typeof ref === 'string' || typeof ref === 'number') {
        ...
        if (usesReferences(to_ret, reg)) {
          ...
          if (Object.hasOwn(foundCirc, reference)) ; else if (stack.indexOf(reference) !== -1) {
...
export { _resolveReferences, resolveReferences };
